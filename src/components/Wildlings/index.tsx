      ...
      <List bulleted>
        ...
        <List.Item>
          <p>
            ...
            отбито, варвары полегли под Стеной 🎉. Откройте верхнюю карту колоды
            одичалых, игрок,сделавший наибольшую ставку своей властью, получает
            награду, указанную в нижней части карты. Если таких игроков
            несколько, владелец железного трона выбирает одного. Переместите
            жетон одичалых на деление 0
          </p>
        </List.Item>
        <List.Item>
          <p>
            Если сила одичалых превзошла силу Ночного дозора варвары
            преодолевают Стену и разоряют лежащие за ней земли Семи королевств.
            Откройте вернюю карту колоды одичалых, игрок, сделавший наименьшую
            ставку своей властью несет тяжелые потери, а затем караются все
            остальнын. Если игроков, сделавших наименьшую ставку несколько,
            владелец железного трона выбирает одного. Переместите жетон одичалых
            на 2 деления вниз (но не меньше 0)
          </p>
        </List.Item>
