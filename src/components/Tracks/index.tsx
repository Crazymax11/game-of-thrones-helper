    ...
    <Container text>
      ...
      <List bulleted>
        <List.Item>
          ...
          жетоны. Борьба идёт за каждый трек по отдельности (сначала за Железный
          трон, потом за Вотчины, и наконец, за Королевский двор).
        </List.Item>
        <List.Item>
          Каждый игрок зажимает в кулак любое количество жетонов: это его
          ставка. Ставки делаются тайно. Когда все игроки сделали ставки, кулаки
          разжимаются.
        </List.Item>
        <List.Item>
        ...
        <List.Item>
          ...
          решает владелец жетона Железного трона. Он выкладывает жетоны влияния
          спорящих Домов на наивысшие (то есть, самые левые) незанятые деления
          оспариваемого трека в любом угодном ему порядке.
          <br />
          <b>
            Это также значит, что если текущий владелец железного трона и
            соперник спорят за первое место в треке железного трона, то спор решает текущий
            владелец железного трона (скорее всего в свою пользу)
          </b>
        </List.Item>
        <List.Item>
          Чем бы ни завершилась борьба за трек влияния, все жетоны власти,
          которые были поставлены игроками на кон, сбрасываются в резерв власти.
        </List.Item>
        <List.Item>
          После того как жетоны влияния размещены на треке по результатам борьбы
          за него, Дом, занявший первое деление на этом треке, получает
          соответствующий жетон превосходства. Затем игроки переходят к борьбе за
          следующий трек.
        </List.Item>
      </List>
      <Divider />
